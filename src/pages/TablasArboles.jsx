...
const columns = [
  ...
  { name: "Numero fustes", selector: row => row.Numero_fustes, sortable: true },
  { name: "Diametro", selector: row => row.Diametro, sortable: true },
  { name: "Altura fuste", selector: row => row.Altura_fuste, sortable: true },
  { name: "Forma fuste", selector: row => row.Forma_fuste, sortable: true },
  { name: "Diametro fuste", selector: row => row.Diametro_fuste, sortable: true },
  { name: "Altura total", selector: row => row.Altura_total, sortable: true },
  { name: "Diametro copa", selector: row => row.Diametro_copa, sortable: true }
];
...
return (
  <>
    ...
    />
    <div className="App">
      <Table columns={columns} data={datosArboles} />
    </div>
  </>
);
}
